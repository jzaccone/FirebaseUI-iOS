...
- (void)authUI:(FUIAuth *)authUI linkAnonyousUserWithAuthCredential:(nonnull FIRAuthCredential *)credential shouldLoginNewUserCallback: (void(^_Nonnull)(BOOL shouldLogin))completion;
